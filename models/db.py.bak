...
auth.settings.hmac_key = 'sha512:052765f8-4331-4adf-8549-45b2e312efd1'   # before define_tables()
...
#db.message.fromid.default=auth.user.id
#db.message.fromid.requires=IS_IN_DB(db, auth.user.id)
